<?php namespace App\Http\Controllers;
	...
	class AdminQuizResultController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->col[] = ["label"=>"App User","name"=>"(select CONCAT( app_users.first_name ,' ',app_users.last_name ) from app_users where quiz_result.user_id = app_users.id) as user_id"];
			...
			$this->col[] = ["label"=>"Course Id","name"=>"course_id","join"=>"courses,title"];
			$this->col[] = ["label"=>"Topic","name"=>"topic_id","join"=>"topics,title"];
			...
			$this->form[] = ['label'=>'Course Id','name'=>'course_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'courses,id'];
			$this->form[] = ['label'=>'Topic Id','name'=>'topic_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'topics,id'];
			...
			//$this->form[] = ['label'=>'Topic Id','name'=>'topic_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'topic,id'];
