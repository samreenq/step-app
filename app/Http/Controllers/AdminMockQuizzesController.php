<?php namespace App\Http\Controllers;
	...
	class AdminMockQuizzesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'Options','path'=>'mock_quiz_options','parent_columns'=>'question','foreign_key'=>'mock_quiz_id',
