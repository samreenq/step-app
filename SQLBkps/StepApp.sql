...
insert  into `quiz_result`(`id`,`total_questions`,`attempted`,`correct`,`wrong`,`score`,`lesson_id`,`course_id`,`user_id`,`status`,`created_at`,`updated_at`) values (3,7,4,2,2,'28.57%',1,NULL,8,'Fail','2019-10-18 11:45:22',NULL),(6,4,3,1,2,'14.29%',15,1,8,'Fail','2019-10-18 17:46:16',NULL);
